module.exports = {
  ...
  fn: async function (inputs, exits) {
      ...
      var page_title = 'Danh sách từ vựng';
      var page_slug = 'words';
      var per_page = 20;
      var page = inputs.page || 1;
      var data_words = await Words.find({ 'active' : 2 }) // .meta({enableExperimentalDeepTargets:true})
      .skip((per_page * page) - per_page).limit(per_page).sort('id DESC');
      var count_words = await  Words.count({ 'active' : 2 });
